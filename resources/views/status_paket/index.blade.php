...
<div class="row">
    <div class="col-md-12">
        <div class="box box-warning">
            ...
            @include('status_paket.add')
            @include('status_paket.edit')
            <div class="card">
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{url('status_paket', $dt->id)}}" id="delete" class="btn btn-sm btn-flat btn-danger btn-hapus"><i class="fa fa-trash"></i> </a>
                                </td>
                            </tr>
                            @endforeach
                            </tbody>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            table.on('click','.edit', function () {
                ...
                $('#editform').attr('action', '/status_paket/'+data[0]);
