                        ...
                        <div class="card card-primary" style="margin-top: 30px">
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    ...
                                    <div class="card-body">
                                        <form enctype="multipart/form-data" role="form" method="post" action="{{url('member/ubahprofile', $dt->id)}}">
                                            @csrf
                                            @method('PUT')
                        ...
                        <div class="card card-primary" style="margin-top: 30px">
                            <div class="card-header">
                                <h3 class="card-title">Ganti Password</h3>
                                    ...
                                    <div class="card-body">
                                        <form role="form" method="post" action="{{url('member/ubahpassword', $dt->id)}}">
                                            @csrf
                                            @method('PUT')
                                            <div class="input-group mb-3">
