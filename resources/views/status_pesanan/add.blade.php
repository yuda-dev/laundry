    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                @endif
                <form role="form" method="post" action="{{url('status_pesanan/add')}}">
                    @csrf
                    <div class="card-body">
                        <div class="form-group">
                            <label for="exampleInputEmail1">Status Paket</label>
                            <input type="text" class="form-control" name="status" id="exampleInputEmail1" placeholder="status pesanan" autocomplete="off">
                        </div>
                        <div class="form-group">
