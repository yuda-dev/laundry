              ...
              <div class="card-body box-profile">
                ...
                <ul class="list-group list-group-unbordered mb-3">
                  <li class="list-group-item">
                    <b>ID Member</b> <a class="float-right">{{ $dt->id_member }}</a>
                  </li>
                  <li class="list-group-item">
              ...
              <div class="card-body">
                <div class="tab-content">
                  <div class="active tab-pane" id="activity">
                    <!-- Post -->
                    <div class="post">
                      <form role="form" enctype="multipart/form-data" method="post" action="{{url('member/ubahprofile')}}">
                        @csrf
                        @method('PUT')
                  ...
                  <div class="tab-pane" id="timeline">
                    <form role="form" method="post" action="{{url('member/ubahpassword')}}">
                      @csrf
                      @method('PUT')
                      <div class="input-group mb-3">
